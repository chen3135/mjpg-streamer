...
#gc2035
./mjpg_streamer -i "./input_uvc.so -d /dev/video0 -u -f 50" -o "./output_http.so -w ./www"
#USB Camera(sn9c201)
#./mjpg_streamer -i "./input_uvc.so -d /dev/video0 -f 50" -o "./output_http.so -w ./www"

#./mjpg_streamer -i "./input_uvc.so -d /dev/video0" -i "./input_uvc.so -d /dev/video0" -o "./output_http.so -w ./www"
